...
//       for (let i = 0; i < 5; i++) {
//         if (result[i] !== "correct" && targetChars.includes(guess[i])) {
//           result[i] = "present";
...
//         feedback.textContent = "Word not in dictionary.";
//         return;
//       }
...
//         feedback.textContent = `💀 Game over! The word was "${wordToGuess.toUpperCase()}".`;
//         input.disabled = true;
//         button.disabled = true;
//       } else {
